...
export IMAGE_URL=${IMAGE_URL-quay.io/tnevrlka-rhtap/rhtap-qe-python:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/tnevrlka-rhtap/rvtz82onx-python-gitops
